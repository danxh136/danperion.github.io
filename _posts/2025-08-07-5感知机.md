...
假设训练数据集为$D=\left\{ (x_{i},y_{i}) \right\}_{i=1}^{m}$，其中， $x_{i}\in\mathbf{X}\subseteq\mathbf{R}^{n}$， $y_{i}\in\mathbf{Y}=\left\{+1,-1\right\}$
感知机模型为:
...
<img src="../assets/images/image-20250820151548781.png" alt="alt" style="zoom:80%;" />
